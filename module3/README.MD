...
```
* now we are ready to create our project.  in the integrated terminal, run the following command  (where \<login server> is the user name for Docker Hub that you created earlier)
```
